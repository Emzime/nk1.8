...
if (defined('TESTLANGUE')) { 
    ...
    function edit_blockHtml($bid) {
        ...
        echo '<div class="content-box">',"\n" //<!-- Start Content Box -->
                ...
                , '<tr><td colspan="4"><b>' , TYPE , ' :</b> ' , HTMLBLOCK , '</td></tr>',"\n"
                , '<tr><td colspan="4"><textarea name="content" rows="10" cols="70"  class="noediteur">' , $content , '</textarea></td></tr>',"\n"
                , '<tr><td colspan="4">&nbsp;</td></tr><tr><td colspan="4" align="center"><b>' , PAGESELECT , ' :</b></td></tr><tr><td colspan="4">&nbsp;</td></tr>',"\n"
