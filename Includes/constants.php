...
define('DEFY_TABLE', $nuked['prefix'] . '_defy');
define('DEFY_PREF_TABLE', $nuked['prefix'] . '_defy_pref');
...
define('LINKS_TABLE', $nuked['prefix'] . '_links');
define('LINKS_CAT_TABLE', $nuked['prefix'] . '_links_cat');
...
define('RECRUIT_TABLE', $nuked['prefix'] . '_recruit');
define('RECRUIT_PREF_TABLE', $nuked['prefix'] . '_recruit_pref');
define('SECTIONS_TABLE', $nuked['prefix'] . '_sections');
define('SECTIONS_CAT_TABLE', $nuked['prefix'] . '_sections_cat');
define('SERVER_TABLE', $nuked['prefix'] . '_server');
define('SERVER_CAT_TABLE', $nuked['prefix'] . '_server_cat');
...
define('SURVEY_TABLE', $nuked['prefix'] . '_survey');
define('SURVEY_CHECK_TABLE', $nuked['prefix'] . '_survey_check');
define('SURVEY_DATA_TABLE', $nuked['prefix'] . '_survey_data');
