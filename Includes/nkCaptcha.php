...
function create_captcha() {
    ...
    <div id="captcha">
        <div id="captchaImg">
            <label class="nkLabelSpacing"><?php echo SECURITYCODE; ?></label>&nbsp;: &nbsp;
            <?php
        ...
        <div id="captchaCheck" class="nkMarginBottom15">
            <label class="nkLabelSpacing" for="code"><?php echo TYPESECCODE; ?></label>&nbsp;:&nbsp;
                <input class="nkInput" type="text" id="code" name="codeConfirm" size="7" maxlength="5" />
        </div>
    </div>
    <?php
    return($random_code);
