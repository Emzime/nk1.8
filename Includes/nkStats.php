...
function getStats($nuked)
{
    ...
    $sql = mysql_query("SELECT count(id), level FROM ". USER_TABLE ." GROUP BY level");
    ...
    . "(SELECT count(id) FROM ". GALLERY_CAT_TABLE .") as galc,"
    . "(SELECT count(id) FROM ". GALLERY_TABLE .") as gal,"
    . "(SELECT count(id) FROM ". LINKS_CAT_TABLE .") as linkc,"
    . "(SELECT count(id) FROM ". LINKS_TABLE .") as link,"
    . "(SELECT count(id) FROM ". WARS_TABLE .") as war,"
    . "(SELECT count(id) FROM ". DOWNLOADS_CAT_TABLE .") as dlc,"
    . "(SELECT count(id) FROM ". DOWNLOADS_TABLE .") as dl,"
    . "(SELECT count(id) FROM ". TEAM_TABLE .") as team,"
