...
if ($visiteur >= 2)
{
    function main()
    {
        ...
        . "function delfile()\n"
        . "{\n"
        . "if (confirm('" . DELETEFILE . " " . VIDERSQL . " ! " . CONFIRM . "'))\n"
        ...
        . "<div class=\"content-box-header\"><h3>" . ADMINSQLERROR . "</h3>\n"
        . "<div style=\"text-align:right;\"><a href=\"help/" . $language . "/Erreursql.php\" rel=\"modal\">\n"
        . "<img style=\"border: 0;\" src=\"help/help.gif\" alt=\"\" title=\"" . _HELP . "\" /></a>\n"
        . "</div></div>\n"
        . "<div class=\"tab-content\" id=\"tab2\"><div style=\"text-align: center;\"><b><a href=\"javascript:delfile();\">" . VIDERSQL . "</a></b></div><br />\n";
        ...
        $sql = mysql_query("SELECT created, link, content  FROM " . $nuked['prefix'] . "_erreursql ORDER BY created DESC");
