...
if ($visiteur == 9)
{
    function main()
    {
        ...
        . "<div class=\"content-box-header\"><h3>" . ADMINMYSQL . "</h3></div>\n"
    ...
    . "<option value=\"index.php?file=Admin&amp;nuked_nude=mysql&amp;op=save_db\">" . SAVEDB . "</option>\n"
    . "<option value=\"index.php?file=Admin&amp;page=mysql&amp;op=optimise\">" . OPTIMIZEDB . "</option>\n"
    . "</select></td></tr></table>\n"
    . "<div style=\"text-align: center;\"><br />[ <a href=\"index.php?file=Admin\"><b>" . BACK . "</b></a> ]</div></form><br /></div>";
    ...
    echo "<div class=\"content-box\">\n" //<!-- Start Content Box -->
        . "<div class=\"content-box-header\"><h3>" . ADMINMYSQL . "</h3></div>\n"
    . "<div class=\"tab-content\" id=\"tab2\"><div style=\"text-align: center;\"><br />" . OPTIMIZEDATABASE . " : <b>" . $global['db_name'] . "</b></div>\n"
    ...
    . "<td style=\"width: 25%;\" align=\"center\"><b>" . STATUT . "</b></td>\n"
    . "<td style=\"width: 20%;\" align=\"center\"><b>" . SPACESAVED . "</b></td></tr>\n";
        ...
        if (is_resource($result) && mysql_num_rows($result))
        {
            while ($row = mysql_fetch_array($result))
            {
                ...
                if ($gain == 0) $statut = NOOPTIMIZE;
        else $statut = "<b>" . OPTIMIZE . "</b>";
        ...
        . "<div style=\"text-align: center;\"><br />[ <a href=\"index.php?file=Admin&amp;page=mysql\"><b>" . BACK . "</b></a> ]</div><br /></div></div>\n";

        // Action
        $texteaction = ACTIONOPTIDB;
        $acdate = time();
        $sqlaction = mysql_query("INSERT INTO ". $nuked['prefix'] ."_action  (`created`, `pseudo`, `action`)  VALUES ('".$acdate."', '".$user[0]."', '".$texteaction."')");
        //Fin action
