...
if ($visiteur == 9)
{
    function index()
    {
		...
		echo "<div class=\"content-box\">\n" //<!-- Start Content Box -->
			...
			. "</div></div>\n"
			. "<div class=\"tab-content\" id=\"tab2\"><div style=\"text-align: center;\"><b><a href=\"index.php?file=Admin&amp;page=themes_slide2&amp;op=add\">" . _ADD . "</a></div><br />\n"
        ...
        $sql = mysql_query("SELECT  id, titre, url, img FROM " . $nuked['prefix'] . "_themes_slide2");
        while (list($bid, $titre, $url, $img) = mysql_fetch_array($sql))
        {
            ...
            . "<td style=\"width: 25%;\" align=\"center\"><a href=\"index.php?file=Admin&amp;page=themes_slide2&amp;op=edit&amp;bid=" . $bid . "\"><img style=\"border: 0;\" src=\"images/edit.gif\" alt=\"\" title=\"" . _EDIT . "\" /></a></td></tr>\n";
    ...
    function edit($bid)
    {
        ...
        $sql = mysql_query("SELECT titre, url, img FROM " . $nuked['prefix'] . "_themes_slide2 WHERE id = '" . $bid . "'");
        while(list($titre, $url, $img) = mysql_fetch_array($sql)){
			...
			. "<img style=\"border: 0;\" src=\"help/help.gif\" alt=\"\" title=\"" . _HELP . "\" /></a>\n"
			. "</div></div>\n"
			. "<div class=\"tab-content\" id=\"tab2\"><form method=\"post\" action=\"index.php?file=Admin&amp;page=themes_slide2&amp;op=send_edit&amp;bid=" . $bid . "\" enctype=\"multipart/form-data\" onsubmit=\"backslash('img_texte');\">\n"
			...
			. "<div style=\"text-align: center;\"><br />[ <a href=\"index.php?file=Admin&amp;page=themes_slide2\"><b>" . _BACK . "</b></a> ]</div></form><br /></div></div>";
		}     
    }
	...
	function send_edit($bid, $titre, $url, $img){
        ...
        echo "<div class=\"notification success png_bg\">\n"
            ...
            $sql = mysql_query("UPDATE ". $nuked['prefix'] ."_themes_slide2 SET titre = '" . $titre . "', url = '" . $url . "', img = '" . $img . "' WHERE id = '" . $bid . "'");
			...
			echo "<script>\n"
				...
				."function screen() { \n"
				."screenon('index.php?file=Admin', 'index.php?file=Admin&page=themes_slide2');\n"
				."}\n"
				."</script>\n";
		}
	}
	...
	function add(){
        ...
        echo "<div class=\"content-box\">\n" //<!-- Start Content Box -->
			...
			. "<form method=\"post\" action=\"index.php?file=Admin&amp;page=themes_slide2&amp;op=do_add\" enctype=\"multipart/form-data\">\n"
	...
	function do_add($titre, $url, $img){
        ...
        echo "<div class=\"notification success png_bg\">\n"
			...
			$sql = mysql_query("INSERT INTO ". $nuked['prefix'] ."_themes_slide2  ( `id`, `titre`, `url`, `img`)  VALUES ('', '".$titre."', '".$url."', '".$img."')");
