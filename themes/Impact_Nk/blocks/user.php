...
echo '<div class="colog">',INWELC,' ',$user[2],' - <a href="index.php?file=User" style="margin-right: 5px;">',INYCOM,'</a>',"\n"
, ' - <a href="index.php?file=User&amp;nuked_nude=index&amp;op=logout">',INDECO,'</a>',"\n"
, '<div>', $mess ,'</div></div>',"\n";
?>